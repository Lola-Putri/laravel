                ...
                <div class="row">
                    <div class="dropdown-center ">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"> Melayani: <br>1. Pelayanan kesehatan umum <br>2.
                                    Konseling kesehatan <br>3. Rujukan <br>4. Surat Sehat <br>5. Surat sakit/dokter</a></li>
            ...
            <div class="col-md-4 box-loket d-flex justify-content-center align-items-center flex-column">
                ...
                <div class="row">
                    <div class="dropdown-center ">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"> Melayani: <br>1. Pengobatan gigi dan mulut <br>2.
                                    Konsultasi gigi dan mulut <br>3. Pencabutan gigi</a></li>
            ...
            <div class="col-md-4 box-loket d-flex justify-content-center align-items-center flex-column">
                ...
                <div class="row">
                    <div class="dropdown-center ">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"> Melayani: <br>1. Pemeriksaan kehamilan <br>2. Nifas
                                    <br>3. kasus</a></li>
