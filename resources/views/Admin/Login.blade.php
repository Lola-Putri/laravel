...
@section('container')
    ...
    <div class="row dashboard-main mt-4">
        <div class="col-md-6 d-flex justify-content-center align-items-center flex-column gap-2">
            ...
            <div class="row">
                ...
                <img style="cursor: pointer" id="eyeicon" src="Image/eye-pass.png"
                        class="eye-pass">
                </div>
            </div>
            <div class="row d-flex w-100">
                ...
                <div class="col-md-6 button-login">
                    <a class="d-flex justify-content-center" href="/instansi"><button type="button"
                            class="btn btn-secondary button">Login</button></a>
                </div>
            </div>
        </div>
    ...
    eyeicon.onclick = function() {
        if (password.type === "password") {
            ...
            eyeicon.src = "Image/eye-pass.png";
        }
    };
});
    </script>
