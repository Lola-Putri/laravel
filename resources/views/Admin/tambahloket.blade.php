            ...
            <div class="row">
                <div class="tabel-que">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-secondary btn-panggil btn-sm">Edit</button>
                                    <button type="button" class="btn btn-secondary btn-sm btn-panggilulang">Hapus</button>
                                </td>
                    ...
                    <div class="row d-flex justify-content-center ">
                        <a href="/tambahloket1"><button type="button" class="btn btn-secondary btn-addloket">Tambah
                                Loket</button></a>
                    </div>
                </div>
            </div>
